...
from display_compliance.proposal_backends import (
    RegionProposalBackend,
    RegionProposalBackendUnavailable,
    Sam2AutomaticMaskBackend,
)
from display_compliance.proposal_backends.sam2_backend import (
...
from display_compliance.segmentation import detect_candidate_regions
...
def test_missing_checkpoint_uses_automatic_cache_resolution(
    ...
    monkeypatch.setattr(
        "display_compliance.proposal_backends.sam2_backend.MIN_CHECKPOINT_BYTES",
        1,
    )
