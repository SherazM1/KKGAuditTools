...
def render():
    ...
    if image_file is not None:
        ...
        # -----------------------------------------------------
            ...
            # Register the component only within a running Streamlit page.
            ...
            canvas_result = st_canvas(
                ...
                key="shelf_audit_expanded_target_canvas",
            )
